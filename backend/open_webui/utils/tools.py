...
async def get_builtin_tools(
    ...
    if (allowed_categories is None or 'notes' in allowed_categories) and (
    ...
    if (
        (allowed_categories is None or 'tasks' in allowed_categories)
        and is_builtin_tool_enabled('tasks')
