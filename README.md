...
> | Area                             | Tweak / Enhancement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Why                                                                                                                                                                                                                                   |
> | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
> | **Service API keys**             | **Group-bound service keys** — admin-mintable long-lived keys for third-party integrations, NOT tied to a user account. `sk_live_<22-char-base62>` (32 chars; plaintext shown once on mint, only prefix recoverable thereafter). Optional expiry (`NULL` = infinite), IP whitelist (CIDR; respects `X-Forwarded-For` / `X-Real-IP` behind a reverse proxy), soft-revoke with `revoked_at`. Three webhook events: `service_key.minted`, `service_key.revoked`, `service_key.expired`. ON DELETE RESTRICT on the group FK — an admin must revoke active keys before deleting the group. Admin UI: **Settings → AI → Service Keys** (`models/service_api_key.py`, `routers/service_keys.py`, `Settings/ServiceKeys.svelte`).                                                                                                                                          | Lets Open WebUI operate as a true hybrid gateway: external callers authenticate against the API without a user account, get the bound group's permissions, hit the bound group's token cap, and trigger webhooks on lifecycle events. |
